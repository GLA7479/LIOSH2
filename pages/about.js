        ...
        <div className="relative z-10 w-full max-w-6xl p-6 rounded-xl">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
            ...
            <div className="text-center md:text-left max-w-xl">
              ...
              <p className="text-lg md:text-xl mb-4 text-white drop-shadow-md">
          ...
          <section className="mb-12 text-center">
            <h2 className="text-3xl font-bold mb-4 text-yellow-300">🌟 Our Mission & Vision</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6 text-center text-cyan-300">🚀 Why Choose LIOSH?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              {[
                ...
                <div key={i} className="p-6 bg-gray-900/70 rounded-xl shadow-lg hover:scale-105 transition">
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-bold mb-6 text-center text-pink-400">📅 Mini Roadmap</h2>
